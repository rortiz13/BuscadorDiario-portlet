...
/**
 * DiarioPlanTableId generated by hbm2java
 */
@Embeddable
public class DiarioPlanTableId implements java.io.Serializable {
	...
	private Clob otherXml;

	public DiarioPlanTableId() {
	}

	public DiarioPlanTableId(String statementId, BigDecimal planId,
			Date timestamp, String remarks, String operation, String options,
			...
			String projection, BigDecimal time, String qblockName, Clob otherXml) {
	...
	public Clob getOtherXml() {
		return this.otherXml;
	}

	public void setOtherXml(Clob otherXml) {
		this.otherXml = otherXml;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof DiarioPlanTableId))
			return false;
		DiarioPlanTableId castOther = (DiarioPlanTableId) other;

		return ((this.getStatementId() == castOther.getStatementId()) || (this
				.getStatementId() != null && castOther.getStatementId() != null && this
				...
				&& ((this.getBytes() == castOther.getBytes()) || (this
						.getBytes() != null && castOther.getBytes() != null && this
						.getBytes().equals(castOther.getBytes())))
				...
				&& ((this.getOther() == castOther.getOther()) || (this
						.getOther() != null && castOther.getOther() != null && this
						.getOther().equals(castOther.getOther())))
				...
				&& ((this.getCpuCost() == castOther.getCpuCost()) || (this
						.getCpuCost() != null && castOther.getCpuCost() != null && this
						.getCpuCost().equals(castOther.getCpuCost())))
				&& ((this.getIoCost() == castOther.getIoCost()) || (this
						.getIoCost() != null && castOther.getIoCost() != null && this
						.getIoCost().equals(castOther.getIoCost())))
				...
				&& ((this.getOtherXml() == castOther.getOtherXml()) || (this
						.getOtherXml() != null
						&& castOther.getOtherXml() != null && this
						.getOtherXml().equals(castOther.getOtherXml())));
	}
		...
		result = 37
				* result
				+ (getQblockName() == null ? 0 : this.getQblockName()
						.hashCode());
		result = 37 * result
				+ (getOtherXml() == null ? 0 : this.getOtherXml().hashCode());
		return result;
	}
